            ...
            <div class="row">
                ...
                <div class="col-12 ">
                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-comprobantes" role="tablist">
                        ...
                        <!-- TAB  -->
                        <li class="nav-item">
                            <a class="nav-link active my-0" id="listado-productos-tab" data-toggle="pill" href="#listado-productos" role="tab" aria-controls="listado-productos" aria-selected="false"><i class="fas fa-shopping-cart"></i>
                        ...
                        <!-- TAB  -->
                        <li class="nav-item">
                            <a class="nav-link my-0" id="comprobante-tab" data-toggle="pill" href="#comprobante" role="tab" aria-controls="comprobante" aria-selected="false"><i class="fas fa-file-invoice"></i>
                                <span class="d-none d-md-inline">
                                    Comprobante
                                </span>
                            </a>
                        ...
                        <!-- TAB  -->
                        <li class="nav-item">
                            <a class="nav-link my-0" id="datos-cliente-tab" data-toggle="pill" href="#datos-cliente" role="tab" aria-controls="datos-cliente" aria-selected="true"><i class="fas fa-user-tie"></i>
                                <span class="d-none d-md-inline">
                                    Cliente
                                </span></a>
                        </li>
                    ...
                    <div class="tab-content" id="custom-tabs-comprobantesContent">
                        ...
                        <div class="tab-pane fade active show" id="listado-productos" role="tabpanel" aria-labelledby="listado-productos-tab">
                        ...
                        <div class="tab-pane fade " id="comprobante" role="tabpanel" aria-labelledby="comprobante-tab">
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-12 col-lg-4 mb-2">
                                    <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-at mr-1 my-text-color"></i>Enviar Comprobante por Correo a:</label>
                        ...
                        <!-- DATOS DEL CLIENTE -->
                        <div class="tab-pane fade" id="datos-cliente" role="tabpanel" aria-labelledby="datos-cliente-tab">
...
<script>
    ...
    function fnc_GuardarVenta() {
        ...
        if ($("#forma_pago").val() == 2) {
            ...
            if ($("#serie").val() === '' || $("#serie").val() === null) {
                mensajeToast("error", "Debe completar los datos del comprobante");
                return;
            }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    //     if ($("#email").val() != '') {
                    //         fnc_EnviarCorreo(response["id_venta"]);
                    //     }
                    // }, 10000);
    ...
    function fnc_EnviarCorreo($id_venta_para_correo) {
